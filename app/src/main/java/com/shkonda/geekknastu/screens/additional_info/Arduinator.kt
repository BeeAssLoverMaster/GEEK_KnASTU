...
@Composable
fun Arduinator(itemList: ListItem) {
    val bullet = "\u2022"
        ...
        item {
            ...
            Card(
                ...
                Row(
                    ...
                    Column(
                        ...
                        Spacer(modifier = Modifier.padding(4.dp))
                        Text(
                            text = "г. Комсомольск-на-Амуре\nФГБОУ ВО \"КнАГУ\", пр. Ленина, 27, корпус 3",
                            textAlign = TextAlign.Center,
                            fontSize = 16.sp,
                            color = White,
                            modifier = Modifier.padding(bottom = 8.dp)
            ...
            Card(
                ...
                Row(
                    ...
                    Column(
                        ...
                        Spacer(modifier = Modifier.padding(4.dp))
                        val messages = listOf(
                            "Прием заявок до 05 ноября 2023 г.",
                            "Отборочный (заочный) этап конкурса с 23 октября по 06 ноября 2023 г.",
                            "Финальный этап конкурса 10 ноября 2023 г.",
                        )
                        Text(
            ...
            Card(
                ...
                Column(
                    ...
                    Text(
                        text = stringResource(id = R.string.arduinator_1),
                        modifier = Modifier.padding(start = 8.dp, top = 8.dp),
                        lineHeight = 20.sp
                    )
                    Spacer(modifier = Modifier.padding(8.dp))
                    Text(
                        text = stringResource(id = R.string.arduinator_2),
                        modifier = Modifier.padding(start = 8.dp),
                        lineHeight = 20.sp
                    )
                    Text(
                        text = stringResource(id = R.string.arduinator_3),
                        modifier = Modifier.padding(start = 8.dp),
                        lineHeight = 20.sp
                    )
                    Spacer(modifier = Modifier.padding(8.dp))
                    Text(
                        text = stringResource(id = R.string.arduinator_4),
                        modifier = Modifier.padding(start = 8.dp),
                        lineHeight = 20.sp
                    )
                    Text(
                    ...
                    Spacer(modifier = Modifier.padding(8.dp))
                    Text(
                        text = stringResource(id = R.string.arduinator_5),
                        modifier = Modifier.padding(start = 8.dp),
                        lineHeight = 20.sp
                    )
